...
import { ArrowRight, CheckCircle2, RotateCcw, Share2 } from "lucide-react";
    ...
    return (
      <div className="max-w-2xl mx-auto p-6 md:p-8 bg-white rounded-3xl border border-gray-200 shadow-sm space-y-8">
        <div className="text-center space-y-2">
          ...
          <div className="text-5xl font-black text-indigo-950 pt-4">{score} / 100</div>
        </div>
        ...
        <div className="text-center space-y-4 pt-2">
          {!pledged ? (
            ...
            <div className="p-6 bg-emerald-50 border border-emerald-200 rounded-2xl text-center space-y-4">
              ...
              <button
                onClick={handleShare}
                className="inline-flex items-center gap-2 bg-emerald-800 text-white px-5 py-2.5 rounded-xl text-xs font-semibold hover:bg-emerald-900 transition"
              >
